...
type Project = {
  _id: string;
  name: string;
  roleInProject?: ProjectRole; // backend may provide
};
...
function docIconByMime(mime?: string, title?: string) {
  ...
  return { Icon: File, color: "text-gray-700" };
}
...
// UI permissions (backend still enforces)
...
export function DocumentsPage() {
    ...
    (async () => {
      ...
      try {
        ...
        if (projRes.status === "fulfilled") {
          ...
          // default upload project (first project user can upload)
  ...
  // ✅ Download with token (fixes “No token provided”)
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          {loadingProjects ? (
            <p className="text-xs text-gray-500 mt-1">Loading your projects…</p>
          ) : !projects.length ? (
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl text-gray-900 mt-1">{fmtBytes(totalStorageBytes)}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl text-gray-900 mt-1">{totalVersions}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl text-gray-900 mt-1">{sharedFilesCount}</p>
              </div>
                        ...
                        <div className="flex items-center gap-4 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <h4 className="text-gray-900 truncate">{doc.title}</h4>
                            ...
                            <div className="flex items-center gap-3 mt-1 text-sm text-gray-600 flex-wrap">
                              ...
                              <span className="flex items-center gap-1">
                                ...
                                {fmtDate(current?.uploadedAt || doc.updatedAt)}
                              </span>
                            </div>
          ...
          <Card>
            ...
            <CardContent>
              {recentVersions.length === 0 ? (
                <div className="py-10 text-center text-gray-500">No version history yet.</div>
              ) : (
        ...
        <TabsContent value="cloud">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Connect your Google Drive to sync and manage files seamlessly</p>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Integrate with Dropbox for easy file sharing and collaboration</p>
                <Button className="w-full" onClick={() => toast.info("Integrate OAuth flow here")}>
                  Connect
                </Button>
              </CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Link your Microsoft OneDrive for centralized document management</p>
                <Button className="w-full" onClick={() => toast.info("Integrate OAuth flow here")}>
                  Connect
                </Button>
              </CardContent>
      ...
      <Dialog open={versionsOpen} onOpenChange={setVersionsOpen}>
        <DialogContent className="max-w-2xl">
          ...
          {loadingVersions ? (
            <div className="py-10 text-center text-gray-500">Loading versions…</div>
          ) : activeDocVersions.length === 0 ? (
            <div className="py-10 text-center text-gray-500">No versions found.</div>
          ) : (
            <div className="space-y-3 max-h-[420px] overflow-auto pr-1">
              {activeDocVersions
                ...
                .map((v) => {
                  ...
                  return (
                    <div key={v.version} className="flex items-start justify-between p-3 border border-gray-200 rounded-lg">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          <Badge variant={isCurrent ? "default" : "outline"}>v{v.version}</Badge>
                          {isCurrent ? <Badge variant="secondary">Current</Badge> : null}
                          <span className="text-sm text-gray-700">{v.fileName}</span>
                        </div>
                        ...
                        {v.changeNote?.trim() ? <p className="text-sm text-gray-600 mt-2">{v.changeNote}</p> : null}
                      </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-3 py-2">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">(Later you can replace this with a searchable dropdown of project members.)</p>
            </div>
          </div>
